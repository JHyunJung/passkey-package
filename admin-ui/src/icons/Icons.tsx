...
function makeIcon(paths: string[], fillPaths?: string[]) {
  return function IconComp({ size = 16, stroke = 1.6, className }: IconProps) {
    ...
    (fillPaths || []).forEach((d, i) => {
      children.push(
        React.createElement('path', { key: 'f' + i, d, fill: 'currentColor', stroke: 'none' })
      );
    });
...
function makeIconR(elements: RichElement[]) {
  return function IconComp({ size = 16, stroke = 1.6, className }: IconProps) {
    return React.createElement(
      'svg',
      {
...
const Shield = makeIcon(['M12 3l8 3v6c0 5-3.5 8.5-8 9-4.5-.5-8-4-8-9V6l8-3z']);
...
const Cog = makeIconR([
  { tag: 'circle', attrs: { cx: 12, cy: 12, r: 3 } },
  {
    tag: 'path',
    attrs: {
      d: 'M19.4 15a1.7 1.7 0 00.3 1.8l.1.1a2 2 0 01-2.8 2.8l-.1-.1a1.7 1.7 0 00-1.8-.3 1.7 1.7 0 00-1 1.5V21a2 2 0 11-4 0v-.1a1.7 1.7 0 00-1-1.5 1.7 1.7 0 00-1.8.3l-.1.1a2 2 0 01-2.8-2.8l.1-.1a1.7 1.7 0 00.3-1.8 1.7 1.7 0 00-1.5-1H3a2 2 0 110-4h.1a1.7 1.7 0 001.5-1 1.7 1.7 0 00-.3-1.8l-.1-.1a2 2 0 012.8-2.8l.1.1a1.7 1.7 0 001.8.3H9a1.7 1.7 0 001-1.5V3a2 2 0 014 0v.1a1.7 1.7 0 001 1.5 1.7 1.7 0 001.8-.3l.1-.1a2 2 0 012.8 2.8l-.1.1a1.7 1.7 0 00-.3 1.8V9a1.7 1.7 0 001.5 1H21a2 2 0 010 4h-.1a1.7 1.7 0 00-1.5 1z',
    },
  },
]);

const Activity = makeIcon(['M3 12h4l3-8 4 16 3-8h4']);
...
const Filter = makeIcon(['M3 4h18l-7 9v7l-4-2v-5L3 4z']);

const Search = makeIconR([
...
const X = makeIcon(['M6 6l12 12M18 6L6 18']);

const Check = makeIcon(['M5 12l5 5L20 7']);

const ChevronDown = makeIcon(['M6 9l6 6 6-6']);

const ChevronRight = makeIcon(['M9 6l6 6-6 6']);

const ChevronLeft = makeIcon(['M15 6l-6 6 6 6']);

const ChevronUp = makeIcon(['M6 15l6-6 6 6']);

const Copy = makeIconR([
...
const Alert = makeIcon([
  'M12 3l10 18H2L12 3z',
  'M12 10v4M12 18h.01',
]);

const Info = makeIconR([
  { tag: 'circle', attrs: { cx: 12, cy: 12, r: 9 } },
  { tag: 'path', attrs: { d: 'M12 11v6M12 8h.01' } },
]);

const Lock = makeIconR([
...
const Refresh = makeIcon(['M21 12a9 9 0 11-3-6.7L21 8M21 3v5h-5']);
...
const Fingerprint = makeIcon([
  'M6 11a6 6 0 0112 0M5 16c2-2 3-4 3-6M19 11c0 4-2 7-4 9M12 11v3c0 2-1 4-2 6M9 21c2-2 3-5 3-9',
]);
