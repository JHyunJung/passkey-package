...
class WellKnownController(
    private val props: WellKnownProperties,
) {

    companion object {
        private val log = LoggerFactory.getLogger(WellKnownController::class.java)
    ...
    fun appleAppSiteAssociation(): Map<String, Any> {
        ...
        return mapOf("webcredentials" to mapOf("apps" to apps))
    }
}
