...
> **그룹 A 완료 (2026-05-31)**: P0 잔여 §2.1(MFA recovery-code)·§2.2(mfa_secret 암호화) + P1-6(lockout/reset)을 단일 worktree·V37 마이그레이션으로 마감. 남은 P1: P1-1~5, P1-7. spec: `docs/superpowers/specs/2026-05-30-admin-account-security-hardening-design.md`.
